...
export namespace Prisma {
  ...
  */
   ...
   * ProjectCountOutputType without action
   */
  export type ProjectCountOutputTypeCountLogsArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: LogWhereInput;
  };
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise";
    logs<T extends Project$logsArgs<ExtArgs> = {}>(
      args?: Subset<T, Project$logsArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
  ...
  export type LogOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    "id" | "message" | "projectId" | "createdAt" | "updatedAt",
    ExtArgs["result"]["log"]
  >;
  ...
  type LogGetPayload<S extends boolean | null | undefined | LogDefaultArgs> =
    $Result.GetResult<Prisma.$LogPayload, S>;
  ...
  > {
    ...
    updateManyAndReturn<T extends LogUpdateManyAndReturnArgs>(
      args: SelectSubset<T, LogUpdateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$LogPayload<ExtArgs>,
        T,
  ...
  export type ProjectWhereInput = {
    ...
    github_url?: StringFilter<"Project"> | string;
  ...
  export type ProjectScalarWhereWithAggregatesInput = {
    ...
    github_url?: StringWithAggregatesFilter<"Project"> | string;
  ...
  export type LogCreateNestedManyWithoutProjectInput = {
    create?:
      | XOR<LogCreateWithoutProjectInput, LogUncheckedCreateWithoutProjectInput>
      | LogCreateWithoutProjectInput[]
      | LogUncheckedCreateWithoutProjectInput[];
    connectOrCreate?:
      | LogCreateOrConnectWithoutProjectInput
      | LogCreateOrConnectWithoutProjectInput[];
  ...
  export type LogUpdateManyWithoutProjectNestedInput = {
    ...
    connectOrCreate?:
      ...
      | LogCreateOrConnectWithoutProjectInput[];
    upsert?:
      | LogUpsertWithWhereUniqueWithoutProjectInput
      | LogUpsertWithWhereUniqueWithoutProjectInput[];
    createMany?: LogCreateManyProjectInputEnvelope;
    ...
    connect?: LogWhereUniqueInput | LogWhereUniqueInput[];
    update?:
      | LogUpdateWithWhereUniqueWithoutProjectInput
      | LogUpdateWithWhereUniqueWithoutProjectInput[];
    updateMany?:
      | LogUpdateManyWithWhereWithoutProjectInput
      | LogUpdateManyWithWhereWithoutProjectInput[];
  ...
  export type ProjectCreateNestedOneWithoutLogsInput = {
    create?: XOR<
      ...
      ProjectUncheckedCreateWithoutLogsInput
    >;
  ...
  export type ProjectUpdateOneRequiredWithoutLogsNestedInput = {
    ...
    update?: XOR<
      XOR<
        ProjectUpdateToOneWithWhereWithoutLogsInput,
        ProjectUpdateWithoutLogsInput
      >,
      ProjectUncheckedUpdateWithoutLogsInput
    >;
  };
  ...
  export type LogUpsertWithWhereUniqueWithoutProjectInput = {
    where: LogWhereUniqueInput;
    update: XOR<
      LogUpdateWithoutProjectInput,
      LogUncheckedUpdateWithoutProjectInput
    >;
    create: XOR<
      LogCreateWithoutProjectInput,
      LogUncheckedCreateWithoutProjectInput
  ...
  export type LogUpdateManyWithWhereWithoutProjectInput = {
    ...
    data: XOR<
      ...
      LogUncheckedUpdateManyWithoutProjectInput
    >;
  };
